...
require.register("nonamemedia~nanoscroller@0.8.0", function (exports, module) {
...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define('nanoscroller', ['jquery'], factory);
  } else if (typeof module !== 'undefined' && module.exports) {
...
module.exports = function() {
	...
	//Add nanoscroll
	require("nonamemedia~nanoscroller@0.8.0");
};
...
module.exports = function() {
    ...
    var XQCore = require("nonamemedia~xqcore@0.8.0"),
        listingModel = require("doxit/models/listing.model.js"),
        itemModel = require("doxit/models/item.model.js"),
        $ = require("components~jquery@2.1.0");
...
require.register("doxit/models/item.model.js", function (exports, module) {
module.exports = function() {
	'use strict';
...
if (typeof exports == "object") {
  module.exports = require("doxit");
} else if (typeof define == "function" && define.amd) {
  define([], function(){ return require("doxit"); });
} else {
  this["doxit"] = require("doxit");
}
})()
