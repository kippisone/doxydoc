module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    stylus: {
      lagoon: {
        options: {
          paths: ['./node_modules/lyssl/', 'stylus']
        },
        files: {
          'templates/lagoon/main.css': 'templates/lagoon/stylus/main.styl'
        }
      },
      'deep-space': {
        options: {
        ...
        files: {
          'templates/deep-space/main.css': 'templates/deep-space/stylus/main.styl'
        }
      }
    },
    uglify: {
